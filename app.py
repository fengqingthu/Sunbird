...
@hops.component(
    ...
    icon="predict.png",
    inputs=[
        hs.HopsNumber("SolarChimneyHeight", "sc_h",
                      "Solar chimney height", default=4.0),
        hs.HopsNumber("SolarChimneyOrient", "sc_o",
                      "Solar chimney orientation", default=0.0),
        hs.HopsNumber("RoomOrient", "rm_o",
                      "Room orientation", default=0.0),
        hs.HopsNumber("RoomWidth", "rm_w",
                      "Room width", default=10.0),
        hs.HopsNumber("RoomDepth", "rm_d",
                      "Room depth", default=10.0),
    ],
    outputs=[
        hs.HopsNumber("FlowRate", "fr", "Air flow rate, m3/hr"),
        hs.HopsNumber("TotalDiscomfortHours", "tdh",
                      "Total discomfort hours all year, hr/yr"),
        hs.HopsNumber("TooHotDiscomfortHours", "thdh",
                      "Too hot discomfort hours all year, hr/yr"),
        hs.HopsNumber("OT_TotalDiscomfortHours", "ot_tdh",
                      "Total discomfort hours during office time, hr/yr"),
        hs.HopsNumber("OT_TooHotDiscomfortHours", "ot_thdh",
                      "Too hot discomfort hours during office time, hr/yr"),
        hs.HopsNumber("NS_OT_TotalDiscomfortHours", "ns_ot_tdh",
                      "New schedule (with cooling) total discomfort hours during office time , hr/yr"),
        hs.HopsNumber("NS_OT_TooHotDiscomfortHours", "ns_ot_thdh",
                      "New schedule (with cooling) too hot discomfort hours during office time , hr/yr"),
        hs.HopsNumber("TotalEnergyUse", "teu",
                      "Total energy use intensity, kwh/yrm2"),
        hs.HopsNumber("CoolingEnergyUSe", "ceu",
